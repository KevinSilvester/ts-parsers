...
extern crate std;
mod cli {
    use clap::builder::{Styles, styling::{AnsiColor, Effects}};
...
mod data {
    ...
    pub mod state {
        ...
        #[automatically_derived]
        impl ::core::marker::Copy for ParserInstallMethod {}
        #[automatically_derived]
        ...
        #[automatically_derived]
        impl ::core::clone::Clone for RestorePoint {
            #[inline]
            fn clone(&self) -> RestorePoint {
                RestorePoint {
                    date: ::core::clone::Clone::clone(&self.date),
                    location: ::core::clone::Clone::clone(&self.location),
                }
        ...
        impl State {
            ...
            pub fn list_restore_points(
                &self,
            ) -> anyhow::Result<Vec<(usize, String, String, String)>> {
                let mut restore_points = ::alloc::vec::Vec::new();
                for (idx, restore_point) in self.restore_points.iter().enumerate() {
                    ...
                    let file_name = restore_point
                        ...
                        .unwrap()
                        .to_string();
                    let file_metadata = match std::fs::metadata(
                            ...
                            {
                                {
                                    ::std::io::_print(
                                        format_args!(
                                            "{0}{1}{0:#}\n",
                                            crate::utils::colors::AMBER,
                                            format_args!(
                                                "[WARNING]: Backup not found \'{0}\'",
                                                file_name,
                                            ),
                                        ),
                                    );
                    ...
                    let file_size = Byte::from_u64(file_metadata.len())
...
mod ops {
    ...
    pub mod parser_ops {
        ...
        #[automatically_derived]
        impl ::core::fmt::Debug for NodePackageManagers {
            #[inline]
            fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                ::core::fmt::Formatter::write_str(
                    f,
        ...
        #[automatically_derived]
        impl ::core::default::Default for NodePackageManagers {
            #[inline]
            fn default() -> NodePackageManagers {
                Self::Pnpm
            }
        }
        #[automatically_derived]
        impl ::core::clone::Clone for NodePackageManagers {
            #[inline]
            fn clone(&self) -> NodePackageManagers {
                match self {
                    NodePackageManagers::Pnpm => NodePackageManagers::Pnpm,
                    NodePackageManagers::Npm => NodePackageManagers::Npm,
                    NodePackageManagers::Yarn => NodePackageManagers::Yarn,
                    NodePackageManagers::Bun => NodePackageManagers::Bun,
                }
            }
        }
        #[allow(
        ...
        #[automatically_derived]
        impl clap::ValueEnum for NodePackageManagers {
            fn value_variants<'a>() -> &'a [Self] {
                &[Self::Pnpm, Self::Npm, Self::Yarn, Self::Bun]
            }
            fn to_possible_value<'a>(
                &self,
            ) -> ::std::option::Option<clap::builder::PossibleValue> {
                match self {
                    Self::Pnpm => Some({ clap::builder::PossibleValue::new("pnpm") }),
                    Self::Npm => Some({ clap::builder::PossibleValue::new("npm") }),
                    Self::Yarn => Some({ clap::builder::PossibleValue::new("yarn") }),
                    Self::Bun => Some({ clap::builder::PossibleValue::new("bun") }),
                    _ => None,
                }
            }
        }
        ...
        pub fn uninstall(lang: &str, destination: &Path) -> anyhow::Result<()> {
            let lang_so = ::alloc::__export::must_use({
        ...
        async fn generate_from_grammar(
            npm: &NodePackageManagers,
            cwd: &Path,
        ) -> anyhow::Result<()> {
...
mod subcommands {
                                        ...
                                        {
                                            {
                                                ::std::io::_print(
                                                    format_args!(
                                                        "{0}{1}{0:#}\n",
                                                        crate::utils::colors::AMBER,
                                                        format_args!("No backups to delete"),
                                                    ),
                                                );
                                            }
                                        };
                                        ...
                                        {
                                            {
                                                ::std::io::_print(
                                                    format_args!(
                                                        "{0}{1}{0:#}\n",
                                                        crate::utils::colors::GREEN,
                                                        format_args!("Backups deleted: {0:?}", ids),
                                                    ),
                                                );
                                            }
                                        };
    ...
    mod compile {
        ...
        use crate::{
            c_println, compiler::{CompilerOption, ZigTargets, select_compiler},
        ...
        impl clap::FromArgMatches for Compile {
            ...
            fn from_arg_matches_mut(
                ...
                let v = Compile {
                    ...
                    from_grammar: __clap_arg_matches
                        .remove_one::<bool>("from_grammar")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
                            "The following required argument was not provided: from_grammar",
                        ))?,
                    npm: __clap_arg_matches
                        .remove_one::<NodePackageManagers>("npm")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
                            "The following required argument was not provided: npm",
                        ))?,
                    ...
                    no_fail_fast: __clap_arg_matches
                        .remove_one::<bool>("no_fail_fast")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
                            "The following required argument was not provided: no_fail_fast",
                        ))?,
                };
                ::std::result::Result::Ok(v)
            }
            ...
            fn update_from_arg_matches_mut(
                ...
                if __clap_arg_matches.contains_id("from_grammar") {
                    #[allow(non_snake_case)]
                    let from_grammar = &mut self.from_grammar;
                    *from_grammar = __clap_arg_matches
                        .remove_one::<bool>("from_grammar")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
                ...
                if __clap_arg_matches.contains_id("npm") {
                    #[allow(non_snake_case)]
                    let npm = &mut self.npm;
                    *npm = __clap_arg_matches
                        .remove_one::<NodePackageManagers>("npm")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
                ...
                if __clap_arg_matches.contains_id("no_fail_fast") {
                    #[allow(non_snake_case)]
                    let no_fail_fast = &mut self.no_fail_fast;
                    *no_fail_fast = __clap_arg_matches
                        .remove_one::<bool>("no_fail_fast")
                        .ok_or_else(|| clap::Error::raw(
                            clap::error::ErrorKind::MissingRequiredArgument,
            ...
            fn augment_args<'b>(__clap_app: clap::Command) -> clap::Command {
                {
                    let __clap_app = __clap_app
                        .group(
                            clap::ArgGroup::new("Compile")
                                .multiple(true)
                                .args({
                                    let members: [clap::Id; 10usize] = [
                                        clap::Id::from("compiler"),
                                        clap::Id::from("target"),
                                        clap::Id::from("all"),
                                        clap::Id::from("from_grammar"),
                                        clap::Id::from("npm"),
                                        clap::Id::from("destination"),
                                        clap::Id::from("tag"),
                                        clap::Id::from("wanted"),
                                        clap::Id::from("parsers"),
                                        clap::Id::from("no_fail_fast"),
                                    ];
                                    members
                                }),
                        );
                    ...
                    let __clap_app = __clap_app
                        .arg({
                            #[allow(deprecated)]
                            let arg = clap::Arg::new("from_grammar")
                                .value_name("FROM_GRAMMAR")
                                .required(false && clap::ArgAction::SetTrue.takes_values())
                                .value_parser({
                                    use ::clap_builder::builder::impl_prelude::*;
                                    let auto = ::clap_builder::builder::_infer_ValueParser_for::<
                                ...
                                .action(clap::ArgAction::SetTrue);
                            let arg = arg
                                .help("Generate the parser from grammar")
                                .long_help(None)
                                .short('f')
                                .long("from-grammar")
                                .default_value("false");
                        ...
                        .arg({
                            ...
                            let arg = arg
                                ...
                                .default_value({
                                    ...
                                    let s = DEFAULT_VALUE
                                        .get_or_init(|| {
                                            let val: NodePackageManagers = <NodePackageManagers as ::std::default::Default>::default();
                                            clap::ValueEnum::to_possible_value(&val)
                                                .unwrap()
                                                .get_name()
                                                .to_owned()
                    ...
                    let __clap_app = __clap_app
                        .arg({
                            #[allow(deprecated)]
                            let arg = clap::Arg::new("no_fail_fast")
                                .value_name("NO_FAIL_FAST")
                                .required(false && clap::ArgAction::SetTrue.takes_values())
                                .value_parser({
                                    use ::clap_builder::builder::impl_prelude::*;
                                    let auto = ::clap_builder::builder::_infer_ValueParser_for::<
                ...
                Self: 'async_trait,
            {
                Box::pin(async move {
                    ...
                    let __ret: anyhow::Result<()> = {
                        ...
                        parser_ops::check_compile_deps(compiler, &__self.npm)?;
                        let mut failed_langs = ::alloc::vec::Vec::new();
                                    ...
                                    {
                                        {
                                            ::std::io::_print(
                                                format_args!(
                                                    "{0}{1}{0:#}\n",
                                                    crate::utils::colors::AMBER,
                                                    format_args!("[WARNING]: \"{0}\" - {1}", lang, e),
                                                ),
                                            );
                                        }
                                    };
                            ...
                            {
                                {
                                    ::std::io::_print(
                                        format_args!(
                                            ...
                                            crate::utils::colors::AMBER,
                                            format_args!(
                                                "\n[WARNING]: Failed to compile parsers - {0:?}",
                                                failed_langs,
                                            ),
                                        ),
                                    );
    ...
    mod install {
        use crate::{
            c_println, compiler::{CompilerOption, select_compiler},
            data::{
                changelog::ChangeLog, parsers::Parsers,
                state::{ParserInstallMethod, State},
            },
            ops::{backups_ops, parser_ops::{self, NodePackageManagers}},
                ...
                Self: 'async_trait,
            {
                Box::pin(async move {
                    ...
                    let __ret: anyhow::Result<()> = {
                        ...
                        if !__self.all && !not_installed.is_empty() {
                            return ::anyhow::__private::Err(
                                ::anyhow::Error::msg(
                                    ::alloc::__export::must_use({
                                        let res = ::alloc::fmt::format(
                ...
                Self: 'async_trait,
            {
                Box::pin(async move {
                    ...
                    let __ret: anyhow::Result<()> = {
                        ...
                        let mut is_locked = ::alloc::vec::Vec::new();
                        let mut up_to_date = ::alloc::vec::Vec::new();
                        let mut update_tags = ::alloc::vec::Vec::new();
                        let mut update_tags_and_parsers = ::alloc::vec::Vec::new();
                        ...
                        match __self.method {
                            ParserInstallMethod::Compile => {
                                parser_ops::check_compile_deps(compiler, &__self.npm)?;
                                for (idx, lang) in update_tags_and_parsers
                                    .iter()
                                    .enumerate()
                                {
                                    let parser = parsers.get_parser(lang).unwrap();
...
mod utils {
    ...
    pub mod colors {
        ...
        pub const BLUE: Style = RgbColor(2, 149, 235).on_default();
        pub const GREEN: Style = RgbColor(57, 219, 57).on_default();
        pub const AMBER: Style = RgbColor(245, 181, 61).on_default();
        pub const TURQUOISE: Style = RgbColor(66, 242, 245).on_default();
        pub const WHITE: Style = RgbColor(255, 255, 255).on_default();
    }
    pub mod command {
        use std::{
            collections::VecDeque, io::{self, IsTerminal},
            path::Path, println, process::Stdio,
        };
        ...
        pub async fn run(
            ...
            let quiet = std::env::var("TS_PARSERS_QUIET").is_ok()
                || !stdin.is_terminal();
            {
                ::std::io::_print(
                    format_args!(
                            ...
                            Item::Stdout(out) => {
                                out_queue
                                    .push_back(
                                        ::alloc::__export::must_use({
                                            let res = ::alloc::fmt::format(
                                                format_args!("   {1}=>{1:#} {0}", strip_str(&out), BLUE),
                                            );
                                            res
                                        }),
                                    );
                            ...
                            Item::Stderr(err) => {
                                out_queue
                                    .push_back(
                                        ::alloc::__export::must_use({
                                            let res = ::alloc::fmt::format(
                                                format_args!("   {1}=>{1:#} {0}", strip_str(&err), RED),
                                            );
                                            res
                                        }),
                                    );
    ...
    pub mod num_args {
        mod errors {
            ...
            trait FancyError {
                ...
                fn construct_error(&self) -> String {
                    ...
                    let white_on_red = white.on(Color::from(RgbColor(235, 66, 66)))
                        | Effects::BOLD;
            ...
            impl ::core::fmt::Debug for LexicalError {
                ...
                fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                    match self {
                        LexicalError::InvalidToken(__self_0, __self_1) => {
                        ...
                        LexicalError::InvalidRange(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "InvalidRange",
                                __self_0,
                        ...
                        LexicalError::UnexpectedEqual(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "UnexpectedEqual",
                                __self_0,
                        ...
                        LexicalError::NoRangeStart(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "NoRangeStart",
                                __self_0,
                        ...
                        LexicalError::NoRangeEnd(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "NoRangeEnd",
                                __self_0,
                ...
                fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
                    match self {
                        ...
                        | LexicalError::NoRangeEnd(_, _) => {
                            f.write_fmt(format_args!("{0}", self.construct_error()))
                        }
                    }
                }
            }
            impl FancyError for LexicalError {
                    ...
                    match self {
                        LexicalError::InvalidToken(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{1}@ position {0}{1:#} {2}- Invalid token{2:#}",
                                        span.0,
                                        blue,
                                        WHITE,
                                    ),
                        ...
                        LexicalError::InvalidRange(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- Invalid range syntax{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
                        ...
                        LexicalError::UnexpectedEqual(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- Unexpected equals sign{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
                        ...
                        LexicalError::NoRangeStart(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{1}@ position {0}{1:#} {2}- No range start specified{2:#}",
                                        span.0,
                                        blue,
                                        WHITE,
                                    ),
                        ...
                        LexicalError::NoRangeEnd(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- No range end specified{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
                ...
                fn error_hint(&self) -> String {
                    match self {
                        LexicalError::InvalidToken(_, _) => {
                            "Only numbers, spaces, ranges and underscore for numbers allowed ;)"
                                .to_owned()
                        }
                        LexicalError::InvalidRange(_, _) => {
                            "Range should be formed like this '1..10' or '1..=10' ;)"
                                .to_owned()
                        }
                        LexicalError::UnexpectedEqual(_, _) => {
                            "Equal sign should come after the two dots '1..=10' ;)"
                                .to_owned()
                        }
                        LexicalError::NoRangeStart(_, _) => {
                            "Place a number right before the '..' or '..=' with no spaces ;)"
                                .to_owned()
                        }
                        LexicalError::NoRangeEnd(_, _) => {
                            "Place a number right after '..' or '..=' with no spaces"
                                .to_owned()
                        }
                    }
                }
            ...
            impl ::core::fmt::Debug for ParserError {
                ...
                fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                    match self {
                        ParserError::MalformedNumber(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "MalformedNumber",
                                __self_0,
                        ...
                        ParserError::NumberTooLarge(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                                "NumberTooLarge",
                                __self_0,
                        ...
                        ParserError::RangeStartGreaterThanEnd(__self_0, __self_1) => {
                            ::core::fmt::Formatter::debug_tuple_field2_finish(
                                f,
                    ...
                    match self {
                        ParserError::MalformedNumber(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- Malformed number{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
                        ...
                        ParserError::NumberTooLarge(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- Number too large. Largest possible number is 4_294_967_295{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
                        ...
                        ParserError::RangeStartGreaterThanEnd(_, span) => {
                            ::alloc::__export::must_use({
                                let res = ::alloc::fmt::format(
                                    format_args!(
                                        "{2}@ position {0}-{1}{2:#} {3}- Range start is greater than range end{3:#}",
                                        span.0,
                                        span.1,
                                        blue,
                                        WHITE,
        ...
        mod lexer {
            ...
            impl ::core::fmt::Debug for TokenKind {
                ...
                fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
                    match self {
                        TokenKind::Space => ::core::fmt::Formatter::write_str(f, "Space"),
                        TokenKind::Int(__self_0) => {
                            ::core::fmt::Formatter::debug_tuple_field1_finish(
                                f,
                                "Int",
                                &__self_0,
            ...
            impl ::core::clone::Clone for TokenKind {
                ...
                fn clone(&self) -> TokenKind {
                    match self {
                        ...
                        TokenKind::Int(__self_0) => {
                            TokenKind::Int(::core::clone::Clone::clone(__self_0))
                        }
                        TokenKind::Range {
                            start: __self_0,
                            end: __self_1,
                            ...
                            TokenKind::Range {
                                ...
                                inclusive: ::core::clone::Clone::clone(__self_2),
                            }
                        }
                    }
                }
            ...
            impl ::core::cmp::PartialEq for TokenKind {
                ...
                fn eq(&self, other: &TokenKind) -> bool {
                    ...
                    __self_discr == __arg1_discr
                        && match (self, other) {
                            (TokenKind::Int(__self_0), TokenKind::Int(__arg1_0)) => {
                                __self_0 == __arg1_0
                            }
                            (
                                TokenKind::Range {
                        ...
                        match *ch {
                            ...
                            '0'..='9' if self.lexing_range => {
                                ...
                                let range_value = match range.kind {
                                    TokenKind::Range { start, end: _, inclusive } => {
                                        (start, inclusive)
                                    }
                                    _ => {
        ...
        mod parser {
            ...
            use super::{errors::ParserError, lexer::{Token, TokenKind}};
            pub struct Parser<'a> {
            ...
            impl<'a> Parser<'a> {
                ...
                pub fn parse(&mut self) -> Result<Vec<u32>, ParserError> {
                    ...
                    while let Some(token) = self.tokens.peek() {
                        match &token.kind {
                            ...
                            TokenKind::Range { start: _, end: _, inclusive: _ } => {
                ...
                fn str_to_u32(
                    ...
                    match num_str.parse::<u32>() {
                        ...
                        Err(e) if e.kind() == &IntErrorKind::PosOverflow => {
                            Err(
                                ParserError::NumberTooLarge(self.input_chars.clone(), span),
                            )
                        }
                        Err(_) => {
                            Err(
                                ParserError::MalformedNumber(self.input_chars.clone(), span),
                            )
                        }
                    }
                }
                fn parse_range(&mut self) -> Result<Vec<u32>, ParserError> {
                    ...
                    let (start_str, end_str, inclusive) = match &token.kind {
                        TokenKind::Range { start, end, inclusive } => {
                            (start, end, inclusive)
                        }
                        _ => {
                            ::core::panicking::panic(
                    ...
                    if start >= end {
                        return Err(
                            ParserError::RangeStartGreaterThanEnd(
                                self.input_chars.clone(),
                                token.span,
                            ),
                        );
...
use crate::cli::Cli;
use clap::Parser;
use tokio::{signal, sync::{Mutex, mpsc}};
enum Shutdown {
    Graceful,
    Borked,
}
fn main() -> anyhow::Result<()> {
    let body = async {
        ...
        });
        {
            ...
            let mut output = {
                let futures_init = (signal::ctrl_c(), shutdown_rx.recv());
                let mut futures = (
